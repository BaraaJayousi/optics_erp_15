...
<div class="force-ltr">
    ...
    <div class="btn-toolbar my-2 gap-2" role="toolbar" aria-label="Prescription actions">
        <div class="btn-group btn-group-sm" role="group" aria-label="Enter">
            <button class="btn btn-primary btn-enter-prescription">
                Enter Prescription
            </button>
        </div>

        <div class="btn-group btn-group-sm" role="group" aria-label="Previous">
            <button class="btn btn-secondary btn-previouse-prescriptions">
                Previous Prescriptions
            </button>
        </div>

        <div class="btn-group btn-group-sm" role="group" aria-label="Print">
            <button class="btn btn-danger btn-print-prescritption">
                Print Prescription
            </button>
        </div>
    </div>
